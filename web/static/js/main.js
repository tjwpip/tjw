...
class TJWApp {
    constructor() {
        ...
        this.modules = [
            ...
            { id: 1007, key: 'upgrade', name: '升级更新', icon: '⬆️', description: '检查更新和升级系统' }
        ];
                ...
                setTimeout(() => {
                    contentArea.innerHTML = `
                        <div class="upgrade-panel success">
                            ...
                            <h3>升级成功！</h3>
                            <p>${result.message}</p>
                            <button class="sfz-btn primary" onclick="window.location.reload()">🔄 点击重启服务</button>
                        </div>
                    `;
                }, 1500);
            } else {
